...
# Run Metadata
Total Processing Time: 33.80 seconds
Total Token Count (not including reasoning): 9317
...
18. Additional Agreements: The vendor must disclose any additional agreements the State would need to sign, such as End User License Agreements (EULA), and provide a PDF version if applicable.
