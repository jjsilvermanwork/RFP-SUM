...
# Run Metadata
Total Processing Time: 58.08 seconds
Total Token Count (not including reasoning): 19129
...
28. Additional Agreements: Identify any additional agreements the State will need to sign to procure your solution, such as an End User License Agreement (EULA), and provide a PDF version if applicable.
